  ...
  return (
    <main>
      <header className="topbar">
        ...
        <nav aria-label="Navegación principal"><a href="#recorrido">Recorrido</a><a href="#codigo">Código</a><a href="#glosario">Glosario</a><span className="progress-pill">{progress}% completo</span></nav>
      </header>
      ...
      <section className="code-path" id="codigo">
        <div className="code-path-heading"><div><p className="eyebrow">Después del recorrido · opcional</p><h2>Ahora sí: manos al código</h2><p>Dos notebooks paralelos para tocar modelos reales sin entrenarlos. Elegí el lenguaje que te resulte más cercano: ambos muestran generación, tokenización, embeddings, activaciones capa a capa y una matriz de atención.</p></div><span className="optional">Fuera de las 5 horas</span></div>
        <div className="code-notebooks">
          <article><div className="notebook-language"><span>PY</span><small>60–90 min · CPU</small></div><h3>Transformers en Python</h3><p>Usá directamente el ecosistema de Hugging Face y PyTorch. Es la ruta más corta para experimentar y la versión que puede ejecutarse en Google Colab.</p><ul><li>Generación con <code>pipeline</code></li><li>Embeddings y similitud coseno</li><li>Estados ocultos y atención</li></ul><div className="notebook-actions"><a className="button primary" href="https://colab.research.google.com/github/almadana/propedeutico-llms/blob/main/notebooks/01_python_transformers.ipynb" target="_blank" rel="noreferrer">Abrir en Colab ↗</a><a href="https://github.com/almadana/propedeutico-llms/blob/main/notebooks/01_python_transformers.ipynb" target="_blank" rel="noreferrer">Ver en GitHub</a></div></article>
          <article><div className="notebook-language"><span>R</span><small>60–90 min · CPU</small></div><h3>Transformers desde R</h3><p>Accedé a los mismos modelos mediante <code>reticulate</code>. El cuaderno explicita el puente con Python y conserva el análisis y las figuras en R.</p><ul><li>Generación con <code>pipeline</code></li><li>Mean pooling y comparaciones</li><li>Activaciones y atención con ggplot2</li></ul><div className="notebook-actions"><a className="button primary" href="https://github.com/almadana/propedeutico-llms/blob/main/notebooks/02_r_transformers.ipynb" target="_blank" rel="noreferrer">Abrir notebook ↗</a><a href="https://github.com/almadana/propedeutico-llms/tree/main/notebooks" target="_blank" rel="noreferrer">Ver instrucciones</a></div></article>
        </div>
        <div className="code-caution"><strong>Qué mirar, más que qué copiar</strong><p>Los cuadernos distinguen IDs, embeddings iniciales, activaciones contextuales y pesos de atención. Las figuras sirven para formular preguntas; una atención vistosa no es, por sí sola, una explicación causal.</p></div>
      </section>
